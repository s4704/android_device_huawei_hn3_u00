...
static int fb_post(struct framebuffer_device_t * Dev, buffer_handle_t Buffer)
{
    ...
    gc_private_handle_t const * hnd = reinterpret_cast<gc_private_handle_t const *>(Buffer);
...
int mapFrameBufferLocked(struct private_module_t * Module)
{
    ...
    uint8_t  refreshQuotient =
    (
            uint8_t( info.upper_margin + info.lower_margin + info.yres )
