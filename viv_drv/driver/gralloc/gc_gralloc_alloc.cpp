...
#include "viv_pxl_formats.h"

#include <gc_hal_user.h>
#include <gc_hal_base.h>

#define PLATFORM_SDK_VERSION 23
...
int _MapBuffer(gralloc_module_t const * Module,
...
static int _TerminateBuffer(gralloc_module_t const * Module,
    private_handle_t * Handle
    )
{
    gceSTATUS status;
...
/*****************************************************************************/
static int gc_gralloc_alloc_framebuffer_locked(alloc_device_t * Dev,
    int Width,
    int Height,
    int Format,
    int Usage,
    ...
    )
{
    ...
    gc_private_handle_t * handle = new gc_private_handle_t(dup(m->framebuffer->fd), bufferSize,
...
static int gc_gralloc_alloc_framebuffer(alloc_device_t * Dev,
    int Width,
    int Height,
    int Format,
    int Usage,
...
static int gc_gralloc_alloc_buffer(alloc_device_t * Dev,
    int Width,
    int Height,
    int Format,
    int Usage,
...
int gc_gralloc_alloc(alloc_device_t * Dev,
    int Width,
    int Height,
    int Format,
    int Usage,
...
/*****************************************************************************/
int gc_gralloc_free(alloc_device_t * Dev, buffer_handle_t Handle)
{
    ...
    gc_private_handle_t const * hnd = reinterpret_cast<gc_private_handle_t const *>(Handle);
