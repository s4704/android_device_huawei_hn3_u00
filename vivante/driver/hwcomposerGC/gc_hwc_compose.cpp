    ...
    )
{
    ...
    */
    ...
    ALOGD("  MULTI-SOURCE BLIT: (eigenL=%d, eigenD=%d) blitRect[%d,%d,%d,%d]",
         EigenL,
         EigenD,
         blitRect.left,
         blitRect.top,
    ...
    ALOGD("   dstRect[%d,%d,%d,%d] dx=%d,dy=%d: 0x%08x->0x%08x",
         dstRect->left,
         dstRect->top,
         dstRect->right,
         dstRect->bottom,
