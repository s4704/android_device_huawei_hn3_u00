...
int gc_gralloc_unmap(gralloc_module_t const * Module, buffer_handle_t Handle)
{
    gc_private_handle_t * hnd = (gc_private_handle_t *)Handle;
...
/*****************************************************************************/
int gc_gralloc_register_buffer(gralloc_module_t const * Module, buffer_handle_t Handle)
{
    int err = 0;
    gc_private_handle_t* hnd = (gc_private_handle_t *) Handle;
...
int gc_gralloc_unregister_buffer(gralloc_module_t const * Module, buffer_handle_t Handle)
{
    gceSTATUS status;
...
int gc_gralloc_unlock(gralloc_module_t const * Module, buffer_handle_t Handle)
{
    if (gc_private_handle_t::validate(Handle) < 0)
        return -EINVAL;
