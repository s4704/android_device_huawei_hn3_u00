    ...
    )
{
    ...
    do
    {
        ...
        ALOGV("PE 2.0 feature is available");
...
int copybit_device_close(struct hw_device_t * dev)
{
    ALOGV("closing copybit device");
